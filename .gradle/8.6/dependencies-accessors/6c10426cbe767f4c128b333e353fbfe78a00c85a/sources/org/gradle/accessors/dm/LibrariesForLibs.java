...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>okhttp3LoggingInterceptor</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>composeUIAnimation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxCoreLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidXTestCoreVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getTest() {
            return create("androidx.core.test");
        }
    ...
    public static class AndroidxCoreKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>test</b> with <b>androidx.test:core-ktx</b> coordinates and
         * with version reference <b>androidXTestCoreVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getTest() {
            return create("androidx.core.ktx.test");
        }
    ...
    public static class AndroidxLifecycleLibraryAccessors extends SubDependencyFactory {
        private final AndroidxLifecycleComposeLibraryAccessors laccForAndroidxLifecycleComposeLibraryAccessors = new AndroidxLifecycleComposeLibraryAccessors(owner);
        private final AndroidxLifecycleRuntimeLibraryAccessors laccForAndroidxLifecycleRuntimeLibraryAccessors = new AndroidxLifecycleRuntimeLibraryAccessors(owner);

        public AndroidxLifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.lifecycle.compose</b>
         */
        public AndroidxLifecycleComposeLibraryAccessors getCompose() {
            return laccForAndroidxLifecycleComposeLibraryAccessors;
        }
    ...
    public static class AndroidxLifecycleComposeLibraryAccessors extends SubDependencyFactory {

        public AndroidxLifecycleComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getViewModel() {
            return create("androidx.lifecycle.compose.viewModel");
        }
    ...
    public static class CoroutinesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>coroutineVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class Junit5LibraryAccessors extends SubDependencyFactory {
        private final Junit5EngineLibraryAccessors laccForJunit5EngineLibraryAccessors = new Junit5EngineLibraryAccessors(owner);

        public Junit5LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>extension</b> with <b>de.mannodermaus.junit5:android-test-extensions</b> coordinates and
         * with version reference <b>mannodermausExtensions</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getExtension() {
            return create("junit5.extension");
        }

        /**
         * Dependency provider for <b>test</b> with <b>org.junit.jupiter:junit-jupiter-api</b> coordinates and
         * with version reference <b>jupiterVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getTest() {
            return create("junit5.test");
        }

        /**
         * Group of libraries at <b>junit5.engine</b>
         */
        public Junit5EngineLibraryAccessors getEngine() {
            return laccForJunit5EngineLibraryAccessors;
        }

    }

    public static class Junit5EngineLibraryAccessors extends SubDependencyFactory {

        public Junit5EngineLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>test</b> with <b>org.junit.jupiter:junit-jupiter-engine</b> coordinates and
         * with version reference <b>jupiterVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getTest() {
            return create("junit5.engine.test");
        }
    ...
    public static class NavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>navigationHilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidXTestCoreVersion</b> with value <b>1.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidXTestCoreVersion() { return getVersion("androidXTestCoreVersion"); }

        /**
         * Version alias <b>compiler</b> with value <b>1.5.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>composeUIAnimation</b> with value <b>1.7.0-beta05</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeUIAnimation() { return getVersion("composeUIAnimation"); }
        ...
        /**
         * Version alias <b>coroutineVersion</b> with value <b>1.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>jupiterVersion</b> with value <b>5.10.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJupiterVersion() { return getVersion("jupiterVersion"); }
        ...
        /**
         * Version alias <b>mannodermausExtensions</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMannodermausExtensions() { return getVersion("mannodermausExtensions"); }

        /**
         * Version alias <b>mockkVersion</b> with value <b>1.13.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationHilt</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNavigationHilt() { return getVersion("navigationHilt"); }

        /**
         * Version alias <b>okhttp3LoggingInterceptor</b> with value <b>4.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOkhttp3LoggingInterceptor() { return getVersion("okhttp3LoggingInterceptor"); }
